...
export declare function createBrowserMcpServer(browser: BrowserClient, agentRuntime?: AgentRuntime, diagnostics?: DiagnosticsLogger): McpServer;
/** Starts the loopback HTTP MCP server and shares one private worker runtime across requests. */
export declare function startHttpMcpServer(browser: BrowserClient, port: number, diagnostics?: DiagnosticsLogger): Promise<HttpServer>;
